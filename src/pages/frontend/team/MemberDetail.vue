  ...
  <section class="container mx-auto py-10 text-gray-700">
    ...
    <div v-if="assignedGroupsLength > 0">
      ...
      <div
        ...
        class="w-3/4 mx-auto mb-6 shadow-2xl rounded-2xl border border-gray-600"
      >
        <div class="w-full my-2 mx-4 grid grid-cols-3">
          <p class="underline">Group Name</p>
          <p class="underline">FTE Value</p>
          <p class="underline">Calculated Wage</p>
        </div>
        <div class="w-full my-2 mx-4 grid grid-cols-3">
          <p>Group Name</p>
          <p>FTE Value</p>
      ...
      <options-section :mode="'member-detail'"></options-section>
    </div>
  </section>
</template>
...
export default {
  ...
  methods: {
    ...
    wageSum() {
      return this.Wages.reduce((a, b) => a + b, 0);
    },
  },
  created() {
